...
**Cryptographic and compliance engineering (LG, superfield co-founder):** Background in decentralized systems, cryptographic protocols, and decentralized identity. Covers zero-knowledge encryption, compliance architecture, cryptographic multi-tenancy, and AI model privacy — the technical requirements that make the protocol trustworthy to enterprise security teams.
