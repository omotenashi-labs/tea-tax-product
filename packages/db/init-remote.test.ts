...
describe('init-remote helpers', () => {
  ...
  it('retargets the admin URL to a specific database', () => {
    expect(
      dbUrl('postgres://admin:secret@example.com:5432/postgres?sslmode=require', 'tea_tax_app'),
    ).toBe('postgres://admin:secret@example.com:5432/tea_tax_app?sslmode=require');
  });
